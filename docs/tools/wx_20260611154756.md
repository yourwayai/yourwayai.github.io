...
short_title: 'Anthropic Agent Skills — AI 定制化时代'
description: 'Anthropic 开源 Agent Skills 参考库，基于 agentskills.io 标准，提供了大模型按需动态加载专有知识和工作流的官方实现参考。'
